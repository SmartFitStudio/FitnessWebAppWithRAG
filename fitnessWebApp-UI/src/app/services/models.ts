...
export { AllenamentoResponse } from './models/allenamento-response';
...
export { NotificaResponse } from './models/notifica-response';
export { PageResponseAllenamentoEsercizioResponse } from './models/page-response-allenamento-esercizio-response';
export { PageResponseAllenamentoResponse } from './models/page-response-allenamento-response';
